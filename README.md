...
+ 'data/' - Папка, в которую 'БЛИЖАЙШИЙ' узел будет записывать свое состояние.
...
### 19) Активация узла в качестве средства проверки
...
#### у меня так,но в кошельке отображается транзакция по присоединению, будем продолжать
